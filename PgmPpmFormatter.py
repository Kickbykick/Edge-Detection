...
GAUSS5x5 = np.array([[1, 3, 6, 3, 1], 
                     ...
                     [6, 25, 41, 25, 6], 
                     [3, 15, 25, 15, 3], 
                     [1, 3, 6, 3, 1]])/253 #sigma = 1
KERNEL1 = np.array([[0, -1, 0], [-1, 5, -1], [0, -1, 0]])
KERNEL2 = np.array([[-1, -1, -1], [-1, 8, -1], [-1, -1, -1]])
DarkRange = 50

def gaussian2dKernel(inputSize, sigma):
    sigma = 1.4
    size = int(inputSize) // 2
    x, y = np.mgrid[-inputSize:inputSize+1, -inputSize:inputSize+1]
...
#######################################################################################
#### Below Code from Professor J, Vaughan
#######################################################################################
...
#     count = 0
#     newData = data[0] #Reshape the list of numbers using the provided row and colums
